            ...
            <div>
                <form name="form1" action="GoToReservationConfirmationPageAction">
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type="radio" id="cash" name="pay" value="Cash" onClick="changeDisabled()">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="radio" id="credit" name="pay" value="Credit card" onClick="changeDisabled()">
                    ...
                    <table>
                        <tr id="cardSelect">
                            ...
                            <td>
                                <!-- カードの種類を選択 -->
                                <select name="card" style="color:black" required><s:property value="card" />
                                    <option value=""></option>
                        ...
                        <tr id="text1">
                            ...
                            <!-- カード名義を入力 -->
                            <td>
                                <input type="text" name="cardHolder" size="30" maxlength="20" pattern="^[A-Z| |]{,20}" title="大文字アルファベット20文字以下で入力してください。" placeholder="名前を入力してください" required/>
                            </td>
                        </tr>
                        ...
                        <tr id="text2">
                            ...
                            <td>
                                <!-- カード番号を入力 -->
                                <input type="password" name="cardNumber" size="30" pattern="[0-9]{16}" maxlength="16" title="数字のみ16桁を入力してください。" placeholder="カード番号を入力してください" required/>
                            </td>
                        </tr>
                        ...
                        <tr id="Period">
                            ...
                            <td>
                                ...
                                <select id="Year" name="cardYear" required>
                                    <option value=""></option>
                        ...
                        <tr id="text3">
                            ...
                            <td>
                                <!-- セキュリティコードを入力 -->
                                <input type="password" name="securityCode" size="30" maxlength="4" pattern="[0-9]{3,4}" title="数字のみ3桁又は4桁を入力してください。" placeholder="セキュリティコードを入力してください" required/>
                            </td>
                        </tr>
                    </table>
