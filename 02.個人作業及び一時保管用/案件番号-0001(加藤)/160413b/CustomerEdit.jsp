			...
			<table class="table">
				...
				<tr>
					...
					<td class="field"><input type="text" size="20"
						...
						title="数字・記号は使用できません" required> <input type="text" size="20"
						name="newFirstName" maxlength="30" placeholder="名前を入力してください"
						pattern="[ぁ-んァ-ヶ亜-黑一-十a-zA-Zａ-ｚＡ-Ｚー]{1,12}" autofocus
				...
				<tr>
					...
					<td id="gender"><input type="radio" name="newGender" value="0"><font color="white">Man
						<input type="radio" name="newGender" value="1" required>Woman</font></td>
				</tr>
