	...
	<div class="contents">
		...
		<s:iterator value="reservationList">
			<s:form action="DeleteReservationAction">
				...
				<input type="hidden" name="reservation_num" value="<s:property value="reservation_num" />"/>
		...
		<div style="display: inline-flex">
			<s:form action="GoToMyPageAction">
				<!--<s:submit type="submit" theme="simple" data-icon="♛"
					class="button pink serif round glass" value="MyPage" />-->
					<button class="button4">MyPage</button>
			</s:form>
			<s:form action="AllDeleteReservationAction">
				<!--<s:submit type="submit" theme="simple" data-icon="♛"
					class="button pink serif round glass" value="AllCancel" />-->
